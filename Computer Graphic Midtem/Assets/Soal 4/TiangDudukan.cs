...
public class TiangDudukan : MonoBehaviour
{
    //Declare Material
    [SerializeField]
    public Material tiangdudukanMaterial;
    ...
    void Start()
    {
        ...
        tiangdudukanMaterial.mainTexture = myTexture;
        ...
        GetComponent<MeshRenderer>().material = tiangdudukanMaterial;
