...
public class Dudukan : MonoBehaviour
{
    //Declare Material
    [SerializeField]
    public Material dudukanMaterial;
    ...
    void Start()
    {
        ...
        //Load Texture
        myTexture = Resources.Load<Texture>("Textures/Wooden");
        //Set Texture to Material
        dudukanMaterial.mainTexture = myTexture;
        ...
        GetComponent<MeshRenderer>().material = dudukanMaterial;
